...
describe Version1::Shots do
  ...
  it 'third frame shots when strike in first and second frame' do
    ...
    expect(shots.at_frames(1)).to eq([10, nil, 10, nil, 1])
    expect(shots.at_frames(2)).to eq([10, nil, 1, 2])
    expect(shots.at_frames(3)).to eq([1, 2])
  end
